...
namespace PurchaseManagament.Persistence.Migrations
{
    ...
    [Migration("20231218075248_pageMappingUpdate")]
    partial class pageMappingUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurchaseManagament.Domain.Entities.Page", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("UpperPageId");

                    b.ToTable("PAGE", (string)null);
                });

            modelBuilder.Entity("PurchaseManagament.Domain.Entities.PageRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("PAGE_ROLE", (string)null);
                });
            ...
            modelBuilder.Entity("PurchaseManagament.Domain.Entities.Page", b =>
                {
                    b.HasOne("PurchaseManagament.Domain.Entities.Page", "UpperPage")
                        .WithMany("LowerPages")
                        .HasForeignKey("UpperPageId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("UPPERPAGE_LOWERPAGE");

                    b.Navigation("UpperPage");
                });

            modelBuilder.Entity("PurchaseManagament.Domain.Entities.PageRole", b =>
                {
                    b.HasOne("PurchaseManagament.Domain.Entities.Page", "Page")
                        .WithMany("PageRoles")
